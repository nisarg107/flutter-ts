...
const updateUserwithTweetIdRepo = (userId, tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.findOneAndUpdate({ uid: userId }, { $push: { tweet: tweetId } });
        if (result) {
            return true;
        }
        else {
...
const deleteUserwithTweetIdRepo = (userId, tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield user_model_1.default.findOneAndUpdate({ uid: userId }, { $pull: { tweet: tweetId } });
        if (result) {
            return true;
        }
        else {
